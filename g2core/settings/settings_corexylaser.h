/*
 * settings_corexylaser.h - Corexy Laser prototype
 * This file is part of the g2core project
 *
 * Copyright (c) 2014 - 2016 Alden S. Hart, Jr.
 * Adapted to CoreXY Kinematics prototype (MIT) by jp.civade@labsud.org
 *
 ...
 */
 ...
 /* For Using GTwo shield, pinout must be modified to activate Spindle Dir 
    ...
    Remement to add on Makefile
    	SETTINGS_FILE="settings_corexy.h"
 */
/***********************************************************************/
/**** Corexy profile ***************************************************/
/***********************************************************************/
...
#define INIT_MESSAGE "Initializing configs to CoreXY profile"
...
#define JERK_MAX_XY    		    50000
#define JERK_MAX_Z    		    100000
...
#define Y_LATCH_VELOCITY            (Y_VELOCITY_MAX * 0.2)
#define Y_LATCH_BACKOFF             2
#define Y_ZERO_BACKOFF              2

#define Z_AXIS_MODE                 AXIS_STANDARD
#define Z_VELOCITY_MAX              30000
...
#define Z_LATCH_VELOCITY            (Z_VELOCITY_MAX * 0.5)
